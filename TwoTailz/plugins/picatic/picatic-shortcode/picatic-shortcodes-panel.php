          ...
          <form action="">
            ...
            <?php if ( !empty($userid) ) { ?>
              ...
              <div class="tab-footer">
                <div class="mce-widget mce-btn mce-btn-has-text" role="button">
                  <button onclick="ButtonDialog.insert(ButtonDialog.local_ed)" role="presentation" type="button" id="insert"><span class="mce-txt">Insert Shortcode</span></button>
                </div>
              </div><!-- /.tab-footer -->
            <?php } else { ?>
        ...
        <div id="tab2" class="tab">
          <?php if ( !empty($userid) ) { ?>
            <form action="">
              ...
              <div class="tab-footer">
                <div class="mce-widget mce-btn mce-btn-has-text" role="button">
                  <button onclick="ButtonDialog2.insert(ButtonDialog2.local_ed)" role="presentation" type="button" id="insert"><span class="mce-txt">Insert Shortcode</span></button>
                </div>
              </div><!-- /.tab-footer -->
            </form>
          <?php } else { ?>
    ...
    <script type="text/javascript">
      var ButtonDialog = {
        ...
        insert : function insertButton(ed) {
          ...
          top.tinymce.activeEditor.execCommand('mceRemoveNode', false, null);
          ...
          top.tinymce.activeEditor.execCommand('mceReplaceContent', false, output);
