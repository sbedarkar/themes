...
if ( !class_exists( 'TC_Forms_Search' ) ) {

	class TC_Forms_Search {

		var $per_page	 = 10;
		var $args		 = array();
		var $post_type	 = 'tc_forms';
		var $page_name	 = 'tc_forms';
		var $items_title	 = 'Forms';

		function __construct( $search_term = '', $page_num = '' ) {
			global $tc;

			$this->page_name	 = $tc->name . '_forms';
		...
		function TC_Form_Search( $search_term = '', $page_num = '' ) {
